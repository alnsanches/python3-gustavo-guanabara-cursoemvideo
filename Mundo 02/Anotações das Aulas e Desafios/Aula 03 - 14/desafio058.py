...
while chute != numero_pensado:
    if 0 <= chute <= 10:
        if numero_pensado < chute:
            print('{}º chute errado! O número que eu pensei é menor. Tente novamente!'.format(quantos_chutes))
        else:
            print('{}º chute errado! O número que eu pensei é maior. Tente novamente!'.format(quantos_chutes))
        quantos_chutes += 1
        chute = int(input('Em qual número eu pensei? '))
    else:
